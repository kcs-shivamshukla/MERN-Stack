...
export default function Signup() {
  ...
  const handleChange = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement, Element>, regEx: string | RegExp) => {
  ...
  const validateFlag = Object.values(formData).every(value => {
    var flag = true
    if(value === '' || validateForm.fullName || validateForm.email || validateForm.password) {
      flag = false
    }
    return flag;
  });
          ...
          >
            <Grid container alignItems="center" justifyContent="center">
              ...
              <TextField
                ...
                helperText={validateForm.fullName ? "Only Characters Allowed with Minimum 3 characters" : ""}
                onChange={onChangeSetState}
                onBlur={(e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement, Element>) => handleChange(e, validName)}
              />
              ...
              <TextField
                ...
                onChange={onChangeSetState}
                onBlur={(e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement, Element>) => handleChange(e, validEmail)}
              />
